...
final class CreateFileDialog extends StatefulWidget {
  /// Creates a create file dialog.
  const CreateFileDialog({
    required this.parentPath,
    super.key,
  });

  /// The parent directory path where the file will be created.
...
final class _CreateFileDialogState extends State<CreateFileDialog> {
  ...
  void _handleCreate() {
    ...
    final result = FileNameValidator.validate(fileName);
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            disabledBackgroundColor: editorTheme.textColorDimmed.withOpacity(0.3),
