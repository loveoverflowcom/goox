...
///
/// This extension provides access to editor-specific colors through the theme
/// system, allowing widgets to retrieve colors via
/// Theme.of(context).extension<EditorThemeExtension>() instead of directly
/// accessing AppColors static constants.
final class EditorThemeExtension extends ThemeExtension<EditorThemeExtension> {
  ...
  ThemeExtension<EditorThemeExtension> lerp(
    ...
    return EditorThemeExtension(
      ...
      textColorDimmed: Color.lerp(
        textColorDimmed,
        other.textColorDimmed,
        t,
      )!,
      ...
      modifiedIndicator: Color.lerp(
        modifiedIndicator,
        other.modifiedIndicator,
        t,
      )!,
    );
  }
